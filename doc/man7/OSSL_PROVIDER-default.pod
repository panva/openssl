...
=item TurboSHAKE, see L<EVP_MD-TURBOSHAKE(7)>

=item KangarooTwelve (KT), see L<EVP_MD-KANGAROOTWELVE(7)>
...
The TURBOSHAKE-128, TURBOSHAKE-256, KT-128 and KT-256 algorithms were added
in OpenSSL 4.1.
